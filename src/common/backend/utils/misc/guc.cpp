...
static void InitConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_evil_detect",
            ...
            NODE_ALL,
            INSTRUMENTS_OPTIONS,
            gettext_noop("Whether open DBSD detect."),
            NULL},
            &u_sess->attr.attr_common.enable_evil_detect,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"xact_abort",
            ...
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Enable xact_abort supported compatibility with D"),
            NULL},
            &u_sess->attr.attr_common.enable_xact_abort,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"skip_new_column_for_ruledef",
            PGC_SUSET,
            NODE_ALL,
            UPGRADE_OPTIONS,
            gettext_noop("control ruledef not to contain newly added column."),
            NULL,
            GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL | GUC_NO_RESET_ALL | GUC_SUPERUSER_ONLY},
            &u_sess->attr.attr_common.skip_new_column_for_ruledef,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_internal_error_code",
            PGC_USERSET,
            NODE_ALL,
            QUERY_TUNING,
            gettext_noop("Enable internal error code"),
            NULL},
            &u_sess->attr.attr_common.enableInternalErrorCode,
            true,
            NULL,
            NULL,
            NULL,
...
static void InitConfigureNamesInt64()
{
    struct config_int64 localConfigureNamesInt64[] = {
        ...
        {{"track_stmt_trace_size",
            ...
            NODE_ALL,
            INSTRUMENTS_OPTIONS,
            gettext_noop("the maximum bytes of statement trace to be gathered."),
            NULL},
            &u_sess->attr.attr_common.track_stmt_trace_size,
            INT64CONST(4096),
            INT64CONST(0),
            INT64CONST(100000000),
            NULL,
