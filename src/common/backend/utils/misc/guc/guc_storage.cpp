...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_recyclebin",
            ...
            NULL,
            NULL},
        {{"enable_tpc_fragment_chunks",
            PGC_POSTMASTER,
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Enable tpc fragment chunks to ensure that chunks are continuously arranged "
                         "when updating transparent page compression table."),
            NULL},
            &g_instance.attr.attr_storage.enable_tpc_fragment_chunks,
            false,
            NULL,
            NULL,
            NULL},
        {{"enable_async_ogai",
            ...
            NODE_ALL,
            UNGROUPED,
            gettext_noop("Enable async ogai."),
            NULL},
            &g_instance.attr.attr_storage.enable_async_ogai,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"page_repair_function",
            PGC_SIGHUP,
            NODE_ALL,
            UNGROUPED,
            gettext_noop("enable page repair ability"),
            NULL,
            },
            &u_sess->attr.attr_storage.enable_page_repair_function,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"ss_enable_distirbution_storage",
            ...
            NULL,
            GUC_SUPERUSER_ONLY},
            &g_instance.attr.attr_storage.dms_attr.enable_distirbution_storage,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_subscription",
            ...
            NODE_SINGLENODE,
            RESOURCES_MEM,
            gettext_noop("Whether to start the publish-subscribe thread."),
            NULL},
        ...
        {{"enable_ivfflat_npu",
            ...
            NODE_SINGLENODE,
            QUERY_TUNING_OTHER,
            gettext_noop("Whether enable ivfflat_npu in datavec"),
            NULL},
            &g_instance.attr.attr_storage.enable_ivfflat_npu,
            false,
            NULL,
            NULL,
            NULL},
        {{"cache_data_on_npu",
            ...
            NODE_SINGLENODE,
            QUERY_TUNING_OTHER,
            gettext_noop("Whether cache data on npu for ivfflat_npu"),
            NULL},
            &g_instance.attr.attr_storage.cache_data_on_npu,
            false,
            NULL,
            NULL,
            NULL},
        {{"enable_mmap",
            ...
            NODE_SINGLENODE,
            QUERY_TUNING_OTHER,
            gettext_noop("Whether enable mmap in hnsw search"),
            NULL},
...
static void InitStorageConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        {{"cbm_xlog_files_epoch",
            PGC_SIGHUP,
            NODE_SINGLENODE,
            WAL,
            gettext_noop("cbm tracking xlog files in one epoch"),
            NULL},
            &u_sess->attr.attr_storage.cbm_xlog_files_epoch,
            1,
            1,
            16,
            NULL,
        ...
        {{"cbm_threads_num",
            ...
            NODE_SINGLENODE,
            WAL,
            gettext_noop("cbm read threads number"),
            NULL},
            &u_sess->attr.attr_storage.cbm_threads_num,
            8,
            1,
            10,
            NULL,
        ...
        {{"clog_buffers",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the number of shared memory buffers of clog."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.NCLOGBuffers,
            1024,
            16,
            67108864,
            NULL,
        ...
        {{"csnlog_buffers",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the number of shared memory buffers of csnlog."),
            NULL,
            GUC_UNIT_BLOCKS},
            &g_instance.attr.attr_storage.NCSNLOGBuffers,
            1024,
            16,
            67108864,
            NULL,
        ...
        {{"wal_receiver_timeout",
            ...
            NULL,
            NULL},
        {{"ds_limit_write_xlog_size",
            PGC_SIGHUP,
            NODE_ALL,
            WAL_SETTINGS,
            gettext_noop("set distribute storage limit write xlog size"),
            NULL,
            GUC_UNIT_KB},
            ...
            NULL,
            NULL},
        {{"parallel_recovery_dispatch_algorithm",
            PGC_POSTMASTER,
            NODE_SINGLENODE,
            RESOURCES_RECOVERY,
            gettext_noop("wal dispatch algorithm. It valid only when enable_batch_dispatch=on"),
            NULL},
            &g_instance.attr.attr_storage.parallel_recovery_dispatch_algorithm,
            2,
            1,
            2,
            NULL,
        ...
        {{"wal_file_preinit_threshold",
            PGC_SIGHUP,
            NODE_ALL,
            WAL_SETTINGS,
            gettext_noop("Threshold for pre-initializing xlogs, in percentages."),
            NULL,
            NULL},
            &u_sess->attr.attr_storage.walFilePreinitThreshold,
            100,
            1,
            100,
            NULL,
...
static void InitStorageConfigureNamesString()
{
    struct config_string localConfigureNamesString[] = {
        ...
        {{"ubs_mem_path",
            ...
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Sets file path of libubsm_sdk.so."),
            NULL},
            &g_instance.attr.attr_storage.ubs_mem_path,
            "libubsm_sdk.so",
            NULL,
            NULL,
            NULL},
        {{"uadk_path",
            ...
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Sets file path of libwd_dae.so."),
            NULL},
            &g_instance.attr.attr_storage.uadk_path,
            "libwd_dae.so",
            NULL,
            NULL,
            NULL},
        {{"ivfflat_npubind_info",
            PGC_POSTMASTER,
            NODE_SINGLENODE,
            QUERY_TUNING_OTHER,
            gettext_noop("Sets npu bind info of ivfflat in datavec."),
            NULL,
            GUC_LIST_INPUT | GUC_LIST_QUOTE | GUC_SUPERUSER_ONLY},
            &g_instance.attr.attr_storage.ivfflat_npubind_info,
            "0",
            NULL,
            NULL,
            NULL},
...
static bool check_ss_fi_packet_loss_entries(char** newval, void** extra, GucSource source)
{
    ...
    if (!g_ss_dms_func.inited || !g_instance.fi_ctx_init_finished) {
        return true;
    }
    ...
    if (ss_fi_set_entries(DDES_FI_TYPE_PACKET_LOSS, entry_list, count) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_packet_loss_entries fail")));
        return true;
    }
    return true;
}
...
static bool check_ss_fi_net_latency_entries(char** newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entries(DDES_FI_TYPE_NET_LATENCY, entry_list, count) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_net_latency_entries fail")));
        return false;
    }
    return true;
}
...
static bool check_ss_fi_cpu_latency_entries(char** newval, void** extra, GucSource source)
{
    ...
    if (!g_instance.fi_ctx_inited.exchange(true) && g_instance.shared_fi_ctx == NULL) {
        ...
        g_instance.fi_ctx_init_finished = true;
    }

    if (!g_instance.fi_ctx_init_finished) {
        return true;
    }
    if (!parse_ss_fi_entry_list(*newval, entry_list, &count)) {
        return false;
...
static bool check_ss_fi_process_fault_entries(char** newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entries(DDES_FI_TYPE_PROCESS_FAULT, entry_list, count) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_process_fault_entries fail")));
        return false;
    }
    return true;
}
...
static bool check_ss_fi_custom_fault_entries(char** newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entries(DDES_FI_TYPE_CUSTOM_FAULT, entry_list, count) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_custom_fault_entries fail")));
        return false;
    }
    return true;
}
...
static bool check_ss_fi_packet_loss_prob(int* newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entry_value(DDES_FI_TYPE_PACKET_LOSS, (unsigned int)int_val) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_packet_loss_prob fail")));
        return false;
    }
...
static bool check_ss_fi_net_latency_ms(int* newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entry_value(DDES_FI_TYPE_NET_LATENCY, (unsigned int)int_val) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_net_latency_ms fail")));
        return false;
    }
...
static bool check_ss_fi_cpu_latency_ms(int* newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entry_value(DDES_FI_TYPE_CPU_LATENCY, (unsigned int)int_val) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_cpu_latency_ms fail")));
        return false;
    }
...
static bool check_ss_fi_process_fault_prob(int* newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entry_value(DDES_FI_TYPE_PROCESS_FAULT, (unsigned int)int_val) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_process_fault_prob fail")));
        return false;
    }
...
static bool check_ss_fi_custom_fault_param(int* newval, void** extra, GucSource source)
{
    ...
    if (ss_fi_set_entry_value(DDES_FI_TYPE_CUSTOM_FAULT, (unsigned int)int_val) != DMS_SUCCESS) {
        ereport(WARNING, (errmsg("[DMS]set parameter ss_fi_custom_fault_param fail")));
        return false;
    }
