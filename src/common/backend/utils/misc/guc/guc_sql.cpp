...
static void InitSqlConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_dpa_hashagg",
            ...
            NODE_ALL,
            QUERY_TUNING_METHOD,
            gettext_noop("Enable DPA hardware accelerated hashagg."),
            NULL},
            &u_sess->attr.attr_sql.enable_dpa_hashagg,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_imcsscan",
            ...
            NODE_ALL,
            QUERY_TUNING_METHOD,
            gettext_noop("Enables the planner's use of in-memory-column-store-scan plans."),
            NULL},
            &u_sess->attr.attr_sql.enable_imcsscan,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_bm25_taat",
            ...
            NODE_ALL,
            QUERY_TUNING_METHOD,
            gettext_noop("Enables taat for bm25 scoring."),
            NULL},
            &u_sess->attr.attr_sql.enable_bm25_taat,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_memoize",
            ...
            NODE_ALL,
            QUERY_TUNING_METHOD,
            gettext_noop("Enables the planner's use of memoize."),
            NULL},
            &u_sess->attr.attr_sql.enable_memoize,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_parse_fusion",
            ...
            NODE_ALL,
            QUERY_TUNING_METHOD,
            gettext_noop("Enable parse fusion feature."),
            NULL},
            &u_sess->attr.attr_sql.enableParseFusion,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_opfusion_reuse",
            ...
            NULL,
            NULL},
        {{"enable_query_parameterization",
            PGC_USERSET,
            NODE_ALL,
            UNGROUPED,
            gettext_noop("whether to enable parameterization on simple query"),
            NULL},
        ...
        {{"enable_special_operator",
            ...
            NODE_ALL,
            COMPAT_OPTIONS,
            gettext_noop("force #, ## operator in lexer of D mode."),
            nullptr},
            &u_sess->enable_special_operator,
            false,
            nullptr,
            nullptr,
            nullptr
...
static void InitSqlConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"streaming_gather_window_interval",
            ...
            NULL,
            NULL},
        {{"gms_stats_history_retention",
            PGC_SIGHUP,
            NODE_ALL,
            STATS,
            gettext_noop("Config statistic history data retention days."),
            gettext_noop("Valid range is -1..365000, -1 means never clear history, 0 means don't save history."),
            GUC_UNIT_DAY},
            &u_sess->attr.attr_sql.gms_stats_history_retention,
            31,
            -1,
            365000,
            NULL,
        ...
        {{"hnsw_earlystop_threshold",
            ...
            NODE_ALL,
            QUERY_TUNING_OTHER,
            gettext_noop("Set the maximum number of iterations in the HnswSearchLayer loop within the earlystop strategy."),
            gettext_noop("Valid range is 160..INT32_MAX-1, INT32_MAX means disable the earlystop strategy.")},
            &u_sess->datavec_ctx.hnsw_earlystop_threshold,
            HNSW_DEFAULT_THRESHOLD,
            HNSW_MIN_THRESHOLD,
            HNSW_MAX_THRESHOLD,
            NULL,
            NULL,
        ...
        {{"rbq_sample_rows",
            ...
            gettext_noop("Valid range is 1000..20,0000,0000.")},
        ...
        {{"ivfpq_kreorder",
            ...
            NODE_ALL,
            QUERY_TUNING_OTHER,
            gettext_noop("Sets the number of samples that need to be reordered after IVFPQ."),
            NULL},
            &u_sess->datavec_ctx.ivfpq_kreorder,
            0,
            0,
            INT_MAX,
            NULL,
        ...
        {{"diskann_probes",
            ...
            gettext_noop("Sets the number of probes."),
            NULL},
            &u_sess->datavec_ctx.diskann_probes,
            128,
            1,
            32768,
            NULL,
...
static void InitSqlConfigureNamesReal()
{
    struct config_real localConfigureNamesReal[] = {
        ...
        {{"bm25_b",
            ...
            NODE_ALL,
            QUERY_TUNING_OTHER,
            gettext_noop("b factor for bm25 metrix."),
            NULL},
            &u_sess->attr.attr_sql.bm25_b,
            0.75,
            0.0,
            1.0,
            NULL,
        ...
        {{"max_score_ratio",
            ...
            NODE_ALL,
            QUERY_TUNING_OTHER,
            gettext_noop("max_score_ratio factor for bm25 metrix."),
            NULL},
            &u_sess->attr.attr_sql.max_score_ratio,
            1.05,
            0.5,
            1.3,
            NULL,
        ...
        {{"stream_multiple",
            ...
            NULL,
            NULL},
        {{"ogai.hybrid_search_ratio",
            PGC_USERSET,
            NODE_ALL,
            QUERY_TUNING_OTHER,
            gettext_noop("Sets the ratio between vector score and BM25 score in hybrid search."),
            gettext_noop("Value ranges from 0 to 1, where 1 means pure vector search and 0 means pure BM25 search.")},
            &u_sess->attr.attr_sql.ogai_hybrid_search_ratio,
            0.75,
            0.0,
            1.0,
            NULL,
...
static void InitSqlConfigureNamesString()
{
    struct config_string localConfigureNamesString[] = {
        ...
        {{"ss_htap_cluster_map",
            ...
            NODE_ALL,
            QUERY_TUNING,
            gettext_noop("Set ss nodelist for HTAP."),
            NULL},
            &g_instance.attr.attr_sql.ss_htap_cluster_map,
            "",
            NULL,
            NULL,
            NULL},
