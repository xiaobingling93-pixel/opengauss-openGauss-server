...
#define SS_BROADCAST_WAIT_FIVE_SECONDS (5000U)
#define SS_BROADCAST_WAIT_ONE_SECOND (1000U)
#define SS_BROADCAST_WAIT_FIVE_MICROSECONDS (5U)
...
#define SS_MAX_UINT64 ULLONG_MAX
...
typedef enum SSBroadcastOp {
    ...
    BCAST_IMCSTORE_VACUUM_LOCAL_MEMORY,
    BCAST_NOITIFY_PRIMARY_LOCAL_MEMORY_SUCCESS,
#endif
    BCAST_END
} SSBroadcastOp;
