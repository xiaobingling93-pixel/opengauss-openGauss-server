...
#define ACL_ALL_RIGHTS_TABLESPACE (ACL_CREATE | ACL_ALTER | ACL_DROP | ACL_COMMENT | ACL_VACUUM)
...
#define ACL_ALL_DDL_RIGHTS_TABLESPACE (ACL_ALTER | ACL_DROP | ACL_COMMENT | ACL_VACUUM)
